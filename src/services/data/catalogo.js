 ...
 * a Supabase (aisladas por empresa vía RLS) y la caché local offline-first, para
 * que los contextos/vistas no sepan de Supabase ni de persistencia.
 *
...
/** Trae las 3 tablas en paralelo. Devuelve filas crudas + el primer error si hubo. */
