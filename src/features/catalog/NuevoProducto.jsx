...
export default function NuevoProducto({ onClose, onToast }) {
  ...
  return (
    <div className="lu-modal-scrim" style={sx('position:fixed;inset:0;z-index:80;display:flex;align-items:center;justify-content:center;padding:16px;background:var(--scrim)')}>
      <div onClick={onClose} style={sx('position:absolute;inset:0')} />
      <div className="lu-modal-card" style={sx('position:relative;width:100%;max-width:420px;background:var(--surface);border:1px solid var(--line2);border-radius:18px;box-shadow:var(--shadow-lg);padding:18px')}>
