...
|---|---|---|---|
| `APP_VERSION` | [src/version.js](web/src/version.js) | `1.16.0` | Se compara con `app_config.latest_version`; se reporta en `estado_dispositivo.app_version` |
...
| `app_config.bundle_version` + `latest_version` | Supabase | `1.16.0` ✅ publicado | Qué bundle OTA deben bajar los teléfonos |
