...
|---|---|---|---|
| `APP_VERSION` | [src/version.js](web/src/version.js) | **`1.39.0`** ✅ publicada por OTA el 17/09 (pines con estado en los tres mapas, ubicación obligatoria al check-in, bot de WhatsApp; HANDOFF §00000) | Se compara con `app_config.latest_version`; se reporta en `estado_dispositivo.app_version` |
...
| `app_config.bundle_version` + `latest_version` | Supabase | **`1.39.0`** ✅ (actualizado por el MCP el 17/09) | Qué bundle OTA deben bajar los teléfonos |
