 ...
 * paradas DEBAJO, en un contenedor scrolleable. Se hizo scrolleable a propósito: la vista del
  ...
  return (
    <div style={sx('flex:1;overflow-y:auto;padding:10px 10px calc(96px + env(safe-area-inset-bottom))')}>
      ...
      <div style={sx('margin-top:14px')}>
        <div style={sx('font-size:11px;font-weight:600;letter-spacing:.08em;text-transform:uppercase;color:var(--faint);margin:0 2px 8px')}>Paradas pendientes · {pend.length}</div>
