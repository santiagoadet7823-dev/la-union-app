...
/* El logo de WhatsApp (glifo monocromo, el trazado de Simple Icons, CC0). Marca los pedidos que
   tomó el BOT: en el pin del mapa, en la muestra de la leyenda y en la lista de pedidos. El
   trazado vive acá una sola vez; `lib/estadoComercio` lo toma para el pin, que es HTML crudo de
   Leaflet y no puede montar un componente. */
...
export const Whatsapp = ({ size = 16, color = 'currentColor' }) => (
